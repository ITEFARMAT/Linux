...
docker run  -p 50000:50000 -e VIRTUAL_HOST=jenkins.br-ag.eu -e VIRTUAL_PORT=8080  -v jenkins_home:/var/jenkins_home -v /var/run/docker.sock:/var/run/docker.sock -d --name jenkins jenkins/jenkins:lts
